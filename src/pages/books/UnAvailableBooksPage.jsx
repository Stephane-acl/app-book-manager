...
const UnAvailableBooksPage = () => {
    ...
    const fetchBooks = async () => {
        ...
        try {
            const data = await API.findAll('BOOKS', "?isAvailable=0")
            setBooks(data);
            setLoading(false);
        } catch (error) {
    ...
    return (
        <>
            <div className="header-available">
                <img src="/static/img/banniere.jpg" alt="Pile de livres"/>
                <div className="section-header">
                    <h1>Liste des livres indisponibles</h1>
...
export default UnAvailableBooksPage;